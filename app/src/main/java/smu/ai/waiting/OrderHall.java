...
public class OrderHall extends AppCompatActivity {

    private Button webbtn, resetbtn, finbtn, btnAdd1, btnMinus1, btnAdd2, btnMinus2, btnAdd3, btnMinus3, btnAdd4, btnMinus4,
            btnAdd5, btnMinus5, btnAdd6, btnMinus6, btnAdd7, btnMinus7, btnAdd8, btnMinus8, btnAdd9, btnMinus9, btnAdd10, btnMinus10, btnAdd11, btnMinus11;
    private TextView Count1, Count2, Count3, Count4, Count5, Count6, Count7, Count8, Count9, Count10, Count11;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(R.string.title_orderhall);
        ...
        webbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                wb.loadUrl("http://61.109.247.21/category.php?code=20111007005218025202");
            }
        });
        ...
        Intent intent = new Intent(OrderHall.this, OrderFin.class);
        finbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(OrderHall.this);
                ...
                builder.setPositiveButton("확인", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Toast.makeText(OrderHall.this, "발주가 완료되었습니다.", Toast.LENGTH_SHORT).show();
                    }
                ...
                builder.setNegativeButton("취소", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(OrderHall.this,"취소하셨습니다.", Toast.LENGTH_SHORT).show();
                    }
                });
